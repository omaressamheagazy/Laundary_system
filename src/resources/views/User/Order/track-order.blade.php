            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-lg-8 col-xl-6">
                    <div class="card border-top border-bottom border-3"
                        style="border-color: #f37a27 !important;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                        <div class="card-body p-5">
                            ...
                            <div class="mx-n5 px-5 py-4" style="background-color: #f2f2f2;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <p class="mb-0">{{ $order->deliveries->price}}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row my-4">
                                <div class="col-md-4 offset-md-8 col-lg-3 offset-lg-9">
                                    <p class="lead fw-bold mb-0" style="color: #f37a27;">MYR{{$order['total_price']}}</p>
                                </div>
                            </div>
