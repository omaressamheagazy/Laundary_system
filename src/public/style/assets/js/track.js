...
const getPositionErrorMessage = (code) => {
    switch (code) {
        case 1:
            alert(
                "Permission denied, please make sure that you enable location, and reload the page."
            );
            break;
        case 2:
...
if (orderStatus == pickUpStatus || orderStatus == deliverStatus) {
    // activate the live location, only if the driver is picking up or deliver user laundry
